...
/**
 * Item in *Features → Default → Primary → FeaturesContent*
 */
export interface FeaturesSliceDefaultPrimaryFeaturescontentItem {
  /**
   * Icon field in *Features → Default → Primary → FeaturesContent*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurescontent[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<"calender" | "bargraph" | "clover" | "hourglass">;

  /**
   * Title field in *Features → Default → Primary → FeaturesContent*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurescontent[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Description field in *Features → Default → Primary → FeaturesContent*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurescontent[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface FeaturesSliceDefaultPrimary {
  ...
  /**
   * FeaturesContent field in *Features → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.featurescontent[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  featurescontent: prismic.GroupField<
    Simplify<FeaturesSliceDefaultPrimaryFeaturescontentItem>
  >;
}
...
/**
 * Item in *Testimonials → Default → Primary → TestimonialContent*
 */
export interface TestimonialSliceDefaultPrimaryTestimonialcontentItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → TestimonialContent*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonial.default.primary.testimonialcontent[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface TestimonialSliceDefaultPrimary {
  ...
  /**
   * TestimonialContent field in *Testimonials → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonial.default.primary.testimonialcontent[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  testimonialcontent: prismic.GroupField<
    Simplify<TestimonialSliceDefaultPrimaryTestimonialcontentItem>
  >;
}
...
export interface TextWithImageSliceDefaultPrimary {
  /**
   * Heading field in *TextWithImage → ImageLeft → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      FeaturesSlice,
      FeaturesSliceDefaultPrimaryFeaturescontentItem,
      ...
      HeroSliceHorizontal,
      TestimonialSlice,
      TestimonialSliceDefaultPrimaryTestimonialcontentItem,
